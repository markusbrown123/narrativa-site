...
export function EventCard({ event }: { event: Event }) {
  return (
    <article
      className={clsx(
        "group flex flex-col h-full overflow-hidden rounded-3xl border border-line bg-white transition-all",
    ...
    >
      {event.image ? (
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-surface-tint">
          <Image
            src={event.image}
